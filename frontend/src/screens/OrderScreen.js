...
import { ORDER_PAY_RESET,ORDER_DELIVER_RESET } from '../constans/orderConstants'
...
const orderId=match.params.id
    ...
    const {loading:loadingDeliver,success:successDeliver} = orderDetails
    ...
    <Row>
            <Col md={8}>
                <ListGroup variant='flush'> 
                    ...
                    <p><strong>Address: </strong> {order.user.name}
